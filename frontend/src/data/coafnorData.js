...
export const coafnorData = {
    ...
    history: {
        ...
        foundingStory: "A COAFNOR tem suas raízes na organização dos agricultores familiares do território noroeste do Paraná. Tudo começou em 2004 com a criação da APLPN (Associação dos Produtores Locais do Paraná Norte), que posteriormente se transformou na APRONOR em 2007. O marco definitivo foi em 17 de setembro de 2009, quando a associação evoluiu para uma cooperativa, nascendo assim a COAFNOR com 25 cooperados fundadores. Desde então, a cooperativa cresceu exponencialmente, chegando aos atuais 161 cooperados, sempre mantendo o foco na agricultura familiar e na sustentabilidade.",
        mission: "Buscar a comercialização de produtos dos cooperados, garantindo a qualidade e excelência no atendimento aos clientes, possibilitando a igualdade e permanência do agricultor no meio rural, priorizando a Agricultura Familiar.",
        achievements: [
